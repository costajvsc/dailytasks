            ...
            <div class="modal-body">
                <form action="/tasks" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" class="form-control" name="description"  style="overflow:auto;resize:none" rows="3" max-length="255" placeholder="Send email to apply programmer job"></textarea>
                    </div>
                    <div class="form-group">
